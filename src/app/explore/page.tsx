...
import { Search, MapPin, Briefcase, GraduationCap, User, Loader2, Radar, Sparkles, Flame, History, ArrowRight } from 'lucide-react';
                                    ...
                                    <form onSubmit={handleSearch} className="flex gap-2">
                                        <div className="relative flex-1 group">
                                            ...
                                            <Input
                                                ...
                                                className="h-14 pl-12 pr-4 border-none bg-transparent text-lg font-bold placeholder:text-muted-foreground/50 placeholder:font-medium focus-visible:ring-0"
                                            />
                                        </div>
                                        <Button
                                            type="submit"
