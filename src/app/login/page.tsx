...
// Note: Facebook login is temporarily disabled due to account restrictions.
// To re-enable, add FacebookAuthProvider from firebase/auth, FacebookIcon component, 
// handleFacebookSignIn function, and the Facebook login Button back to the UI.
    ...
    <div className="flex min-h-screen flex-col bg-background">
      ...
      <div className="flex flex-1 flex-col items-center justify-center bg-gradient-to-br from-background via-accent/5 to-background p-4 text-center">
        ...
        <div className="mt-12 w-full max-w-xs space-y-3">
          <Button onClick={handleGoogleSignIn} size="lg" className="w-full font-bold">
            <GoogleIcon />
