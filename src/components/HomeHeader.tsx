...
const hintPackages: HintPackage[] = [
    { id: 1, name: "10 Hint", numHints: 10, amount: 1000 },
    { id: 2, name: "50 Hint", numHints: 50, amount: 4500 },
    { id: 3, name: "100 Hint", numHints: 100, amount: 8000 },
];
    ...
    return (
        <>
            ...
            <div className="container mx-auto max-w-2xl p-4 py-8 space-y-6">
                ...
                <Card className="relative overflow-hidden bg-gradient-to-br from-primary/90 to-primary">
                    <div className="absolute -bottom-10 -right-10 w-40 h-40 text-primary-foreground/10">
                    ...
                    <div className="relative">
                        ...
                        <CardContent className="text-center">
                            <div className="text-6xl font-bold text-white">{totalHints}</div>
