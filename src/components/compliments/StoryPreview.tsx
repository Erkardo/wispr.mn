...
export const StoryPreview = forwardRef<HTMLDivElement>((props, ref) => {
    return (
        <div ref={ref} className="relative aspect-[9/16] w-full max-w-sm mx-auto rounded-2xl overflow-hidden bg-gradient-to-br from-purple-400 to-indigo-600 p-6 flex flex-col justify-between items-center text-white text-center">
            {/* Background elements */}
            ...
            <div className="relative z-10 w-full pt-16">
                ...
                <p className="text-white/80 mt-2">Нэрээ мэдэгдэлгүйгээр 💛</p>
            </div>
